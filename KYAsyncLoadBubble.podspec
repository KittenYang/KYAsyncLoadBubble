#
#  Be sure to run `pod spec lint KYWaterWaveView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/KittenYang/KYAsyncLoadBubble.git", :tag => s.version.to_s }
